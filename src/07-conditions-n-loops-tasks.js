...
function doRectanglesOverlap(rect1, rect2) {
  if (rect1.left + rect1.width < rect2.left || rect1.top + rect1.height < rect2.top || rect1.left > rect2.left + rect2.width || rect1.top > rect2.top + rect2.height) {
    return false;
  }
  return true;
}
...
function findFirstSingleChar(str) {
  ...
  for (const i of str) { if (str.indexOf(i) === str.lastIndexOf(i)) return i; }
  return null;
}
...
function getMatrixProduct(m1, m2) {
  ...
  const bNumRows = m2.length; const bNumCols = m2[0].length;
